...
class Home : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val foodName = listOf("Burgar","sandwitch","momo","samosa")
        val price = listOf(5,7,15,20)
        ...
        binding.popularRecylarView.layoutManager = LinearLayoutManager(requireContext())
        binding.popularRecylarView.adapter = adapter
    }
